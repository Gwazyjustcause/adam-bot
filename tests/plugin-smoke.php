...
if ( 'admin' === $test_mode ) {
	...
	test_assert( isset( $test_routes['adam-bot/v1/guided'], $test_routes['adam-bot/v1/guided/(?P<id>\\d+)'], $test_routes['adam-bot/v1/guided-events'] ), 'Guided navigation REST routes were not registered.' );
...
if ( 'public' === $test_mode ) {
	...
	test_assert( 'https://example.test/wp-json/adam-bot/v1/guided-events' === ( $localized['guidedEventsUrl'] ?? '' ), 'Guided analytics REST URL is incorrect.' );
